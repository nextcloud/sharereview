OC.L10N.register(
    ...
    "Confirm reviewed" : "Bekräfta som granskad",
    "Reset time" : "Återställ tidpunkt",
    "Export report" : "Exportera rapport",
    "Show talk shares" : "Visa Talk-delningar",
    "Select folder" : "Välj mapp",
    "Share deleted" : "Delningen har tagits bort",
    "Table not reloaded" : "Tabellen har inte laddats om",
    "Request could not be processed" : "Begäran kunde inte bearbetas",
    "Timestamp saved" : "Tidsstämpeln har sparats",
    "Timestamp deleted" : "Tidsstämpeln har tagits bort",
    "Report created" : "Rapporten har skapats",
    ...
    "Review and audit all shares" : "Granska och kontrollera alla delningar",
    "This app can be used for auditing shares within a Nextcloud instance e.g. for data loss prevention.\nShare status can be exported for documentation.\n\n- Review any file share\n  - files, talk, deck, teams, federation\n  - app specific shares (if implemented by other apps)\n- Remove shares\n- Confirm current review\n  - show only new shares next time\n- Audit compliance\n- Assign review to user groups (e.g. audit or risk mgmt)\n- Export as CSV or PDF (manual or regular background job)\n\nNote:\nThe app must be restricted to at least one specific user group in the app store.\nThis prevents accidental exposure of the shared content to all users." : "Den här appen kan användas för att granska delningar i en Nextcloud-instans, exempelvis för att förhindra dataförlust.\nDelningsstatus kan exporteras för dokumentation.\n\n- Granska alla fildelningar\n  - filer, Talk, Deck, team och federation\n  - appspecifika delningar (om de har implementerats av andra appar)\n- Ta bort delningar\n- Bekräfta den aktuella granskningen\n  - visa endast nya delningar nästa gång\n- Granska efterlevnad\n- Tilldela granskning till användargrupper (t.ex. revision eller riskhantering)\n- Exportera som CSV eller PDF (manuellt eller via ett regelbundet bakgrundsjobb)\n\nObs!\nAppen måste begränsas till minst en specifik användargrupp i appbutiken.\nDetta förhindrar att delat innehåll oavsiktligt exponeras för alla användare.",
    ...
    "Pause reload after deletion" : "Pausa omladdningen efter borttagning",
    "No share found" : "Ingen delning hittades",
    "Shares are being retrieved, please wait …" : "Delningar hämtas, vänta …",
